...
public class MoodUtil {
	...
	public static ArrayList<Mood> getMoodForList(Context context, Paging p,
		...
		if (appContext.isNetworkConnected()
			...
			SoapWebServiceUtil moodSoap = new SoapWebServiceUtil("Mood",
					"getMoodForList", params);
	...
	public static int addMood(Mood mood) throws AppException {
		...
		SoapWebServiceUtil memberSoap = new SoapWebServiceUtil("Mood",
				"addMood", params);
	...
	public static ArrayList<Mood> getUserMoodForList(Context context,
			long userId, Paging p, boolean isRefresh) throws AppException {
		ArrayList<Mood> moodList = new ArrayList<Mood>();
