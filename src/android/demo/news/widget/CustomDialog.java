package android.demo.news.widget;

import android.app.Dialog;
import android.content.Context;
import android.content.DialogInterface;
import android.demo.news.R;
import android.demo.news.adapter.ProvinceAdapter;
...
import android.demo.news.ui.TabUserActivity;
import android.demo.news.widget.adapter.ArrayWheelAdapter;
...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			/* 构造wheel start */
			final WheelView province = (WheelView) layout
			...
			province.addScrollingListener(new OnWheelScrollListener() {
				...
				public void onScrollingFinished(WheelView wheel) {
					scrolling = false;
					updateCities(city, CommonSetting.cities,
							...
							.setOnClickListener(new View.OnClickListener() {
								...
								public void onClick(View v) {
									positiveButtonClickListener.onClick(dialog,
											...
											provinceid, cityid);
									CommonSetting.ids = positiveButtonClickListener
											.getIds();
									Log.i(TAG, CommonSetting.ids[0] + "  "
											+ CommonSetting.ids[1]);
		 ...
		 */
		private void updateCities(WheelView city, CityEntity cities[][],
				int index) {
			ArrayWheelAdapter<CityEntity> adapter = new ArrayWheelAdapter<CityEntity>(
		 ...
		 * @param cityid
		 */
		private void initializeCities(WheelView city, CityEntity cities[][],
