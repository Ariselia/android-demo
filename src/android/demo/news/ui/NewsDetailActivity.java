...
public class NewsDetailActivity extends IdeaCodeActivity {
	 ...
	 */
	private void loadNewsDetailData(final String newsDetail_url,
			boolean isRefresh) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (order == getResources().getInteger(R.integer.menu_share_index)) {
			...
			UIHelper.showShare(NewsDetailActivity.this,
					newsDetail.getNewsDetailsTitle(),
	...
	public void refresh(Object... param) {
		...
		case TaskType.TS_EXAM_SEARCH_NEWS_DETAIL_LOAD:
			if (param[2] != null && (Integer) param[2] != 0) {
				...
				if (newsDetail == null
						|| newsDetail.getNewsDetailsTitle() == null) {
					finish();
					...
					mPubDate.setText(StringUtils.friendly_time(newsDetail
							.getNewsDetailsCreateDate()));

					String body = UIHelper.WEB_STYLE
							+ newsDetail.getNewsDetailsBody();
