...
import android.demo.news.common.util.FileUtils;
import android.demo.news.common.util.MethodsCompat;
import android.demo.news.common.util.UIHelper;
import android.demo.news.common.util.UpdateManager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		loadimage
				.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
					@Override
					public boolean onPreferenceClick(Preference preference) {
						UIHelper.changeSettingIsLoadImage(
								TabSettingActivity.this, loadimage.isChecked());
