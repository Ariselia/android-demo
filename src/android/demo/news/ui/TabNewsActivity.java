...
import android.demo.news.adapter.ScrollingTabsAdapter;
...
import android.demo.news.widget.ScrollableTabView;
...
public class TabNewsActivity extends IdeaCodeActivity {
		...
		lvNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("newsType",
						Integer.parseInt(newsTitle.get("newsType").toString()));
	...
	private void initPointsBanner() {
		...
		// OffersBanner mMiniBanner = new OffersBanner(this,
		// OffersAdSize.SIZE_MATCH_SCREENx32);
		// RelativeLayout layoutOffersMiniBanner = (RelativeLayout)
		// findViewById(R.id.OffersMiniBannerLayout);
	...
	public void refresh(Object... param) {
		...
		case TaskType.TS_EXAM_SEARCH_NEWS:
			lvNews.onRefreshComplete(getString(R.string.pull_to_refresh_update)
		...
		case TaskType.TS_EXAM_SEARCH_NEWS_MORE:
			if (param[2] != null && (Integer) param[2] != 0) {
				...
				if (newsList == null || newsList.size() == 0) {
					...
					lvNewsData = newsList;
					HeaderViewListAdapter listAdapter = (HeaderViewListAdapter) lvNews
							.getAdapter();
