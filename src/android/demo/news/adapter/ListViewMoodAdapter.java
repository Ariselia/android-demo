package android.demo.news.adapter;
...
import android.demo.news.common.util.ExpressionUtil;
import android.demo.news.common.util.StringUtils;
import android.demo.news.ui.TabMoodActivity;
...
public class ListViewMoodAdapter extends BaseAdapter {
	...
	public ListViewMoodAdapter(TabMoodActivity activity, Context context,
			ArrayList<Mood> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.userName = (TextView) convertView
					.findViewById(R.id.mood_listitem_username);
			listItemView.moodContent = (TextView) convertView
					.findViewById(R.id.mood_listitem_content);
			listItemView.moodDate = (TextView) convertView
					.findViewById(R.id.mood_listitem_date);
			listItemView.moodLocation = (TextView) convertView
					.findViewById(R.id.mood_listitem_location);
			listItemView.flag = (ImageView) convertView
					.findViewById(R.id.mood_listitem_flag);
			listItemView.moodPraiseCount = (TextView) convertView
					.findViewById(R.id.mood_praise_count);
			listItemView.moodBelittleCount = (TextView) convertView
					.findViewById(R.id.mood_belittle_count);
			listItemView.praiseBtn = (ImageButton) convertView
					.findViewById(R.id.mood_praise_img);
			listItemView.belittleBtn = (ImageButton) convertView
					.findViewById(R.id.mood_belittle_img);
			listItemView.praiseLayout = (LinearLayout) convertView
					.findViewById(R.id.mood_praise_layout);
			listItemView.belittleLayout = (LinearLayout) convertView
					.findViewById(R.id.mood_belittle_layout);
		...
		listItemView.moodDate.setText(StringUtils.friendly_time(mood
				.getMoodCreateDate()));
		...
		listItemView.moodPraiseCount.setText(String.valueOf(mood
				.getMoodPraiseCount()));
		listItemView.moodBelittleCount.setText(String.valueOf(mood
				.getMoodBelittleCount()));
