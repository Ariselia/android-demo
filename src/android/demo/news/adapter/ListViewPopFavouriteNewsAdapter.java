...
public class ListViewPopFavouriteNewsAdapter extends BaseAdapter {
	...
	public ListViewPopFavouriteNewsAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.heatFlag = (ImageView) convertView
					.findViewById(R.id.news_listitem_heatflag);
		...
		listItemView.date.setText(StringUtils.friendly_time(map.get("date")
				.toString()));
