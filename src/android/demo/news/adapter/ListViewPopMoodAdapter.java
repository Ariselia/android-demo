...
public class ListViewPopMoodAdapter extends BaseAdapter {
	...
	public ListViewPopMoodAdapter(Context context, ArrayList<Mood> data,
			int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.heatFlag = (ImageView) convertView
					.findViewById(R.id.mood_listitem_heatflag);
			listItemView.moodPraiseCount = (TextView) convertView
					.findViewById(R.id.mood_listitem_praisecount);
			listItemView.moodBelittleCount = (TextView) convertView
					.findViewById(R.id.mood_listitem_belittlecount);
